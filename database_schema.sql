-- ============================================================================
-- Service Request Portal - Complete Database Schema
...
CREATE TABLE RepairabilityStatuses (
...
CREATE TABLE CustomerTerritories (
    Id INT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE ServiceRequests (
    ...
    FOREIGN KEY (CustomerNumber) REFERENCES Customers(CustomerNumber),
    FOREIGN KEY (CountryCode) REFERENCES Countries(CountryCode),
    FOREIGN KEY (RepairabilityStatus) REFERENCES RepairabilityStatuses(StatusCode),
...
CREATE TABLE TerritoryMappings (
    Id INT IDENTITY(1,1) PRIMARY KEY,
...
CREATE VIEW vw_RequestMetrics AS
SELECT
    CountryCode,
    Status,
    RepairabilityStatus,
...
INSERT INTO Languages (LanguageCode, LanguageName, IsActive) VALUES
('en', 'English', 1),
('de', 'German', 1),
('fr', 'French', 1),
('it', 'Italian', 1),
...
INSERT INTO Countries (CountryCode, CountryName, DefaultLanguage, SupportedLanguages) VALUES
('CA', 'Canada', 'en', '["en", "fr"]'),
...
INSERT INTO RepairabilityStatuses (StatusCode, StatusName, RepairLocation, IsActive) VALUES
...
INSERT INTO IssueReasons (MainReason, SubReason, LanguageCode, DisplayOrder) VALUES
...
GO
CREATE PROCEDURE sp_GenerateRequestCode
    @CountryCode NVARCHAR(10),
